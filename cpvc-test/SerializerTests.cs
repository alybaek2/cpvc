...
namespace CPvC.Test
{
    public class SerializerTests
    {
        ...
        static object[] CoreActionCases =
        {
            ...
            new object[] { CoreAction.CreateSnapshot(0x01234567, 42), new byte[] { 0x0a, 0x67, 0x45, 0x23, 0x01, 0x00, 0x00, 0x00, 0x00, 0x2a, 0x00, 0x00, 0x00 }, false },
            new object[] { CoreAction.RevertToSnapshot(0x01234567, 42), new byte[] { 0x0c, 0x67, 0x45, 0x23, 0x01, 0x00, 0x00, 0x00, 0x00, 0x2a, 0x00, 0x00, 0x00 }, false },
            new object[] { CoreAction.DeleteSnapshot(0x01234567, 42), new byte[] { 0x0b, 0x67, 0x45, 0x23, 0x01, 0x00, 0x00, 0x00, 0x00, 0x2a, 0x00, 0x00, 0x00 }, false },
