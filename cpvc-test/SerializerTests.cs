...
namespace CPvC.Test
{
    public class SerializerTests
    {
        ...
        static object[] CoreRequestCases =
        {
            ...
            new object[] { CoreRequest.LoadSnapshot(42), new byte[] { 0x08, 0x42} },
            new object[] { CoreRequest.SaveSnapshot(42), new byte[] { 0x09, 0x42} },
        ...
        static object[] CoreActionCases =
        {
            ...
            new object[] { CoreAction.LoadSnapshot(0x01234567, 42), new byte[] { 0x08, 0x67, 0x45, 0x23, 0x01, 0x42} },
            new object[] { CoreAction.SaveSnapshot(0x01234567, 42), new byte[] { 0x09, 0x67, 0x45, 0x23, 0x01, 0x42} },
