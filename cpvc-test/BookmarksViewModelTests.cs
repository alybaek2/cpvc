...
namespace CPvC.Test
{
    ...
    public class BookmarksViewModelTests
    {
        ...
        public void Setup()
        {
            ...
            _bookmark1Event = _history.AddBookmark(100, new Bookmark(false, 0, (byte[])null, null));
            ...
            _bookmark2Event = _history.AddBookmark(200, new Bookmark(false, 0, (byte[])null, null));
            ...
            _bookmark3Event = _history.AddBookmark(500, new Bookmark(false, 0, (byte[])null, null));
