...
//                    machine => {
//                        MachineViewModel machineViewModel = new MachineViewModel(machine, _mockFileSystem.Object, _canExecuteChangedInvoker);
...
//                new ViewModelFactory<IMachine, MachineViewModel>(
//                    machine => {
//                        MachineViewModel machineViewModel = new MachineViewModel(machine, mockFileSystem.Object, _canExecuteChangedInvoker);

//                        machineViewModel.PromptForFile += (sender, args) =>
//                        {
...
//            MainViewModel mainViewModel = new MainViewModel(mockSettings.Object, mockFileSystem.Object, factory, _canExecuteChangedInvoker);
