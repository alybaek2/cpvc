...
".\OpenCover.4.7.922\tools\OpenCover.Console.exe" -target:".\NUnit.ConsoleRunner.3.11.1\tools\nunit3-console.exe" -targetargs:"cpvc-test\bin\x64\Debug\cpvc-test.dll" -filter:"+[cpvc]* +[cpvc-core-clr]* -[cpvc-test]*" -excludebyfile:"d:\agent\*";"c:\program files*";"*App.g.cs";"*.xaml.cs";"*\obj\*";"*.xaml";"*.Designer.cs";"*Socket.cs";"Display.cs" -hideskipped:All -register:user -output:cpvc-coverage.xml
