...
"C:\Program Files\OpenCppCoverage\OpenCppCoverage.exe" --modules cpvc-core-test --export_type cobertura:cpvc-core-coverage.xaml --sources cpvc "x64\Debug\cpvc-core-test.exe"
